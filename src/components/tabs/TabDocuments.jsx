    ...
    <div className="animate-fade">
      <div className="tab-page-head">
        <div>
          ...
          <p className="tab-page-sub">Store contracts, invoices, purchase orders and project files for {project?.name || 'the project'}.</p>
        </div>
      </div>
      ...
      >
        ...
        <p style={{ color: '#64748b', fontSize: '0.9rem', maxWidth: '380px', lineHeight: 1.5, fontFamily: 'Inter, sans-serif' }}>
          The Document Repository module is currently under development. Please check back later.
        </p>
      </div>
    </div>
  );
